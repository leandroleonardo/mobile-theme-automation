...
export function getHexadecimal(cor) {
  ...
  if (cor.includes("sc-")) return variavelCSS;
  else return temas[temaAtual][variavelCSS];
}
...
export function getViewByComponent(component) {
  let cenario1 = ['Link', 'Avaliação', 'Ícone', 'Botão', 'toggle', 'Caixa de checagem'];
  let cenario2 = ['Abas', 'ItemIcon', 'textInputIcon', 'Deslizar'];
